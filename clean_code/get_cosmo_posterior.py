...
##################    user choices     ##########################################
case = '75SNIa25SNII'                         # choose contamination case
...
version = '1'                                 # realization or version

# path to input (auxiliary files) and output directories
#dir_output = '/media/RESSPECT/data/for_metrics/final_data/' + field + '/v' + version + '/'
...
dir_input = '/media2/RESSPECT2/clean_output/final_data/misc/'
...
os.system('SALT2mu.exe ' + fname_salt2mu)
...
# fit Bayesian model
model = pystan.StanModel(file = dir_input + 'misc/cosmo.stan')
